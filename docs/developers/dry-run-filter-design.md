---
title: Scale-Up Simulation Design for Cluster Autoscaler
---
...
- [HAMi scheduler filter implementation](https://github.com/Project-HAMi/HAMi/blob/master/pkg/scheduler/scheduler.go)
- [HAMi scheduler route implementation](https://github.com/Project-HAMi/HAMi/blob/master/pkg/scheduler/routes/route.go)
- [HAMi scheduler filter tests](https://github.com/Project-HAMi/HAMi/blob/master/pkg/scheduler/scheduler_test.go)
- [HAMi scheduler route tests](https://github.com/Project-HAMi/HAMi/blob/master/pkg/scheduler/routes/route_test.go)
- [HAMi scheduler server](https://github.com/Project-HAMi/HAMi/blob/master/cmd/scheduler/main.go)
- [HAMi extender Helm configuration](https://github.com/Project-HAMi/HAMi/blob/master/charts/hami/templates/scheduler/configmap.yaml)
- [HAMi scheduler Service](https://github.com/Project-HAMi/HAMi/blob/master/charts/hami/templates/scheduler/service.yaml)
