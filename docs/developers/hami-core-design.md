...
HAMi-core is a hook library designed for the CUDA environment. It functions as an in-container GPU resource controller and has been adopted by projects like [HAMi](https://github.com/Project-HAMi/HAMi) and [Volcano](https://github.com/volcano-sh/devices).
