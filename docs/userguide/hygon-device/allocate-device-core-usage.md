...
Allocate a percentage of device core resources by specifying resource `hygon.com/dcucores`. Optional, each unit of `hygon.com/dcucores` equals 1% of device cores.
