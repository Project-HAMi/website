---
title: "验证 AI Agent 驱动的 Kubernetes GPU 管理：基于 HAMi 与 kagent 的实践"
date: "2026-05-28"
...
一张 NVIDIA L40S，通过 HAMi 被切分为 10 张虚拟 GPU；一个通过 kagent 以 Kubernetes CRD 形式部署的 AI Agent；跨独立会话的 A2A（Agent-to-Agent）委托机制；整个系统运行在开源模型之上，不依赖任何闭源组件。
