...
> **NOTICE1:** *你可以在这里找到更多样例 [examples/metax folder](https://github.com/Project-HAMi/HAMi/tree/release-v2.6/examples/metax/sgpu)*
...
> **NOTICE2:** *你可以在这里找到更多样例 [examples/metax folder](https://github.com/Project-HAMi/HAMi/tree/release-v2.6/examples/metax/gpu)*