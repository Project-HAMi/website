...
- Remove DRA components from the HAMi main Helm chart; Ascend DRA support has moved to the dedicated [ascend-dra-driver](https://github.com/Project-HAMi/ascend-dra-driver) repository by ([@archlitchi](https://github.com/archlitchi)) in [#2038](https://github.com/Project-HAMi/HAMi/pull/2038)
- Add init container support with correct GPU resource accounting by ([@maishivamhoo123](https://github.com/maishivamhoo123)) in [#1773](https://github.com/Project-HAMi/HAMi/pull/1773)
- Add PodGroup (gang scheduling) support, including NodeLock retries in Bind and compatibility with the gangScheduling feature gates on Kubernetes v1.36+ by ([@lin121291](https://github.com/lin121291)) and ([@archlitchi](https://github.com/archlitchi)) in [#2066](https://github.com/Project-HAMi/HAMi/pull/2066) and [#2206](https://github.com/Project-HAMi/HAMi/pull/2206)
- Add flexible MIG with dynamic MIG instance allocation and deallocation by ([@FouoF](https://github.com/FouoF)) in [#2378](https://github.com/Project-HAMi/HAMi/pull/2378)
- Add a new mutex GPU scheduling policy and support comma-separated policy combinations by ([@mesutoezdil](https://github.com/mesutoezdil)) in [#2011](https://github.com/Project-HAMi/HAMi/pull/2011) and [#2621](https://github.com/Project-HAMi/HAMi/pull/2621)
- Add opt-in NUMA topology alignment (CPU and GPU) for vGPU replicas by ([@saiyam1814](https://github.com/saiyam1814)) in [#2065](https://github.com/Project-HAMi/HAMi/pull/2065)
- Add support for Biren devices by ([@DSFans2014](https://github.com/DSFans2014)) in [#1711](https://github.com/Project-HAMi/HAMi/pull/1711)
- Add AMD MI300x series vGPU support by ([@FouoF](https://github.com/FouoF)) in [#2290](https://github.com/Project-HAMi/HAMi/pull/2290)
- Allow mode-agnostic Ascend pods to schedule across both vNPU-template and HAMi-core nodes by ([@ouyangluwei163](https://github.com/ouyangluwei163)) in [#2035](https://github.com/Project-HAMi/HAMi/pull/2035)
- Add Ascend 910C vNPU templates vir05_1c_16g and vir10_3c_32g by ([@ouyangluwei163](https://github.com/ouyangluwei163)) in [#2005](https://github.com/Project-HAMi/HAMi/pull/2005)
- Stop trimming device memory to template alignment when using HAMi-core mode for vNPU by ([@archlitchi](https://github.com/archlitchi)) in [#2696](https://github.com/Project-HAMi/HAMi/pull/2696)
- Switch the HAMi-core compile image to ubi8 to support all GLIBC versions by ([@spencercjh](https://github.com/spencercjh)) in [#1958](https://github.com/Project-HAMi/HAMi/pull/1958)
#### Major bug fixes

- Fix MIG failures, allow multiple MIG instances on one GPU, and skip nvidia-mig-parted when MIG is disabled by ([@DSFans2014](https://github.com/DSFans2014)), ([@saiyam1814](https://github.com/saiyam1814)) and ([@maishivamhoo123](https://github.com/maishivamhoo123)) in [#1819](https://github.com/Project-HAMi/HAMi/pull/1819), [#2724](https://github.com/Project-HAMi/HAMi/pull/2724) and [#1930](https://github.com/Project-HAMi/HAMi/pull/1930)
- Stop MIG usage corruption and file descriptor leaks by ([@adity1raut](https://github.com/adity1raut)) in [#2245](https://github.com/Project-HAMi/HAMi/pull/2245)
- Bound-check MIG template and instance indexes parsed from UUID annotations by ([@mesutoezdil](https://github.com/mesutoezdil)) in [#2088](https://github.com/Project-HAMi/HAMi/pull/2088)
- Detect NVLink through NVSwitch for topology scoring by ([@peachest](https://github.com/peachest)) in [#2103](https://github.com/Project-HAMi/HAMi/pull/2103)
- Harden HTTP servers and migconfig file permissions by ([@mesutoezdil](https://github.com/mesutoezdil)) in [#2100](https://github.com/Project-HAMi/HAMi/pull/2100)
- Fix node lock handling: preserve concurrent node locks, roll back partial device locks, and prevent Cambricon node lock leaks by ([@ShiroKSH](https://github.com/ShiroKSH)), ([@AyushSrivastava1818](https://github.com/AyushSrivastava1818)) and ([@jianzhangbjz](https://github.com/jianzhangbjz)) in [#2197](https://github.com/Project-HAMi/HAMi/pull/2197), [#2626](https://github.com/Project-HAMi/HAMi/pull/2626) and [#2329](https://github.com/Project-HAMi/HAMi/pull/2329)
- Clean up podManager on Bind failures to prevent resource leaks by ([@peachest](https://github.com/peachest)) in [#1927](https://github.com/Project-HAMi/HAMi/pull/1927)
- Fix data races by returning copies instead of shared pointers from node usage inspection, the node manager, and the pod manager by ([@DSFans2014](https://github.com/DSFans2014)), ([@mesutoezdil](https://github.com/mesutoezdil)) and ([@AyushSrivastava1818](https://github.com/AyushSrivastava1818)) in [#1967](https://github.com/Project-HAMi/HAMi/pull/1967), [#2055](https://github.com/Project-HAMi/HAMi/pull/2055) and [#2333](https://github.com/Project-HAMi/HAMi/pull/2333)
- Fix ResourceQuota accounting: clamp negative usage, enforce quotas for every device backend, and honor an explicit zero limit by ([@mesutoezdil](https://github.com/mesutoezdil)), ([@Lakshya77089](https://github.com/Lakshya77089)) and ([@veyron-kairo](https://github.com/veyron-kairo)) in [#1880](https://github.com/Project-HAMi/HAMi/pull/1880), [#2347](https://github.com/Project-HAMi/HAMi/pull/2347) and [#2313](https://github.com/Project-HAMi/HAMi/pull/2313)
- Recover scheduling on nodes with stale `Deleted_` handshake annotations and parse handshake timestamps in local timezone by ([@saiyam1814](https://github.com/saiyam1814)) and ([@mesutoezdil](https://github.com/mesutoezdil)) in [#1843](https://github.com/Project-HAMi/HAMi/pull/1843) and [#1816](https://github.com/Project-HAMi/HAMi/pull/1816)
- Validate `gpumem-percentage` ranges and treat a value of 0 as unset to prevent silent unschedulability by ([@saiyam1814](https://github.com/saiyam1814)) and ([@Wangmin362](https://github.com/Wangmin362)) in [#1997](https://github.com/Project-HAMi/HAMi/pull/1997) and [#2156](https://github.com/Project-HAMi/HAMi/pull/2156)
- Fix panic paths in vGPUmonitor and the scheduler, including nil request bodies, zero-value division, and out-of-range device indexes by ([@devGPP23](https://github.com/devGPP23)), ([@lin121291](https://github.com/lin121291)) and ([@Nakshatra480](https://github.com/Nakshatra480)) in [#2384](https://github.com/Project-HAMi/HAMi/pull/2384), [#1820](https://github.com/Project-HAMi/HAMi/pull/1820) and [#2400](https://github.com/Project-HAMi/HAMi/pull/2400)
- Resolve stale annotations in multi-container Allocate by ([@peachest](https://github.com/peachest)) in [#2380](https://github.com/Project-HAMi/HAMi/pull/2380)
- Resolve the high-cardinality leak in `memory_allocated_bytes` metrics by ([@Aryanbhargava18](https://github.com/Aryanbhargava18)) in [#2142](https://github.com/Project-HAMi/HAMi/pull/2142)
- Fix chart issues: derive `ld.so.preload` from `devicePlugin.libPath` and stop the global image tag from overriding per-component tags by ([@ilia-medvedev](https://github.com/ilia-medvedev)) and ([@FouoF](https://github.com/FouoF)) in [#1714](https://github.com/Project-HAMi/HAMi/pull/1714) and [#1774](https://github.com/Project-HAMi/HAMi/pull/1774)
#### What's changed

### Other changes

- Support RTX PRO 6000 Blackwell dynamic MIG by ([@shkatara](https://github.com/shkatara)) in [#2135](https://github.com/Project-HAMi/HAMi/pull/2135)
- Support Enflame DRS by ([@FouoF](https://github.com/FouoF)) in [#1872](https://github.com/Project-HAMi/HAMi/pull/1872)
- Deny privileged containers in the admission webhook by ([@Jay2006sawant](https://github.com/Jay2006sawant)) in [#2139](https://github.com/Project-HAMi/HAMi/pull/2139)
- Sign release images, publish provenance, pin CI actions by hash, and run CodeQL on pull requests by ([@mesutoezdil](https://github.com/mesutoezdil)) in [#2110](https://github.com/Project-HAMi/HAMi/pull/2110), [#2147](https://github.com/Project-HAMi/HAMi/pull/2147) and [#2193](https://github.com/Project-HAMi/HAMi/pull/2193)
- Support template node simulation filtering in the scheduler by ([@spencercjh](https://github.com/spencercjh)) in [#2046](https://github.com/Project-HAMi/HAMi/pull/2046)
- Add device type labels and node labels to metrics by ([@princexpoddar](https://github.com/princexpoddar)) and ([@SK8-infi](https://github.com/SK8-infi)) in [#2554](https://github.com/Project-HAMi/HAMi/pull/2554) and [#2580](https://github.com/Project-HAMi/HAMi/pull/2580)
- Bump the Go builder to 1.26 and update dependencies by ([@mesutoezdil](https://github.com/mesutoezdil)) in [#2710](https://github.com/Project-HAMi/HAMi/pull/2710) and [#2747](https://github.com/Project-HAMi/HAMi/pull/2747)
#### New contributors
...
**Full Changelog**: https://github.com/Project-HAMi/HAMi/compare/v2.9.0...v2.10.0
