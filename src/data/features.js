...
const features = [
  ...
  },
  {
    ...
    description: (
      <Translate>
        Jointly initiated by Internet, finance, manufacturing, cloud providers,
        etc. Target for open governance with CNCF
      </Translate>
    ),
    reverse: true,
  },
  {
    ...
    description: (
      <Translate>
        Integration with mainstream cloud providers; Not tied to proprietary
  ...
  },
  {
    ...
    description: (
      <Translate>
        Provides hard isolation of resources within containers, task in
        containers can't use resources that exceed their quota
      </Translate>
    ),
    reverse: true,
  },
  ...
  },
  {
    ...
    description: (
      <Translate>
        Unified monitoring system, Configurable scheduling
        policies(binpack,spread,etc...)
      </Translate>
    ),
    reverse: true,
  },
